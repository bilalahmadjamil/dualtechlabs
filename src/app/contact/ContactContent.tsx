...
export default function ContactContent() {
  ...
  return (
    <div className="relative flex min-h-[calc(100dvh-5rem)] flex-col items-center justify-center overflow-hidden py-14 md:min-h-[calc(100dvh-5.5rem)] md:py-20 lg:py-28 dtl-bg-light">
      <div
      ...
      <div className="dtl-section relative z-10 w-full max-w-4xl">
        {/* Back link — prominent, near top */}
        <motion.div {...fadeUp(0)} className="mb-8 text-left">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 font-sans text-sm font-medium text-slate-400 transition-colors hover:text-white"
          >
            ← Back to home
          </Link>
        </motion.div>

        <motion.div {...fadeUp(0.08)} className="mb-8 text-center md:mb-12 lg:mb-16">
          <h1
            className="font-display font-bold tracking-tight"
            style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", lineHeight: 1.02, letterSpacing: "-0.03em", color: "#0F172A" }}
          >
            Say hello.
          </h1>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          >
            <motion.div className="flex flex-col gap-5" {...cardLift}>
              <div
              ...
              <p className="font-sans text-sm font-medium transition-colors duration-200 group-hover:text-dtl-purple" style={{ color: "rgba(124,58,237,0.7)" }}>
                {contactEmail}
              </p>
              <div className="mt-auto flex items-center gap-2 rounded-xl px-5 py-3 font-sans text-sm font-semibold text-white transition-[filter] duration-200 group-hover:brightness-110" style={{ background: "linear-gradient(135deg,#7C3AED,#06B6D4)" }}>
                Send an Email
          ...
          <motion.a
            ...
            className="group dtl-card-l dtl-gradient-border flex flex-col gap-5 p-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-dtl-cyan/40 md:p-8 lg:p-10"
          >
            <motion.div className="flex flex-col gap-5" {...cardLift}>
              <div
                className="flex h-14 w-14 items-center justify-center rounded-2xl transition-all duration-300 group-hover:scale-110"
              ...
              <p className="font-sans text-sm font-medium" style={{ color: "rgba(6,182,212,0.8)" }}>
