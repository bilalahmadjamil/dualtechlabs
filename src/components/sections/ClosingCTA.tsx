...
export default function ClosingCTA() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(135deg, #3B0764 0%, #5B21B6 25%, #7C3AED 55%, #0E7490 100%)",
      }}
    >
      {/* Noise texture overlay — makes gradient feel premium not flat */}
      <div
      ...
      <div className="dtl-section relative z-10 flex flex-col items-center text-center">
        ...
        >
          {/* Inverted white button — stands out on dark gradient */}
          <MagneticButton
            as="a"
            href={mailtoUrl}
            className="dtl-cta-primary-inv w-full justify-center sm:w-auto"
            strength={0.3}
          >
            Email Us
          </MagneticButton>
          ...
          <MagneticButton
            ...
            strength={0.3}
            className="w-full justify-center sm:w-auto inline-flex items-center gap-2.5 rounded-full border border-white/30 bg-white/10 px-7 py-3.5 font-sans text-sm font-semibold tracking-wide text-white transition-[background-color,border-color] duration-200 ease-out hover:bg-white/20 hover:border-white/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60 focus-visible:ring-offset-2 sm:px-9 sm:py-4"
          >
        ...
        <motion.p
          ...
          className="mt-8 font-sans text-xs text-white/40"
        >
